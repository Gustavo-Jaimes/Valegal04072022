				...
				<div class="uk-width-expand@m uk-visible@m header">
					<div class="uk-text-center container" uk-grid>
						...
						<div class="uk-width-expand@m">
							...
							<p class="uk-padding-remove uk-margin-remove anuncio">(33) 3641 1000</p>
						</div>
						<div class="uk-width-expand@m ">
							<div class="uk-flex uk-flex-middle  uk-flex-left item">
							...
							<p class="uk-padding-remove uk-margin-remove anuncio">administrativo@valegal.mx</p>    
						</div>
						<div class="uk-width-expand@m ">
							<div class="uk-flex uk-flex-middle  uk-flex-left item">
		...
		<div class="bg-footer ">
			<div class="uk-text-center uk-flex uk-flex-middle container" uk-grid>
				<div class="uk-width-1-3@m footer-img">
					<img src="./img/design/logo_blanco.png" class="rounded mx-auto d-block" alt="...">
				</div>
				<div class="uk-width-auto@m"></div>
				<div class="uk-width-expand@m uk-padding-remove">
					<p class="info">Información de Contacto</p>
					<p class="direccion">J. Gpe. Montenegro 2116, interior 2, Americana 44160, Guadalajara, Jal. MX.</p>
				</div>
				<div class="uk-width-expand@m uk-padding-remove">
					<div class="uk-flex uk-flex-center u-flex-middle">
						<i class="fa fa-phone raya"></i>
						<p class="m-0 tel">(33) 3641 3973 Ext. 110</p>
					</div>
					<div class="uk-flex uk-flex-center u-flex-middle" >
                        <i class="fa fa-envelope raya"></i>
                        <p class="m-0 uk-flex uk-flex-left tel">administracion@valegal.mx</p>
                    </div>    
				</div>
				<div class="uk-width-auto@m"></div>
